...
import {
    MotionBlurPass
} from '../Passes/motionBlurPass/src/MotionBlurPass.js';
import {
    BokehPass
...
export default class PostProcess {
    ...
    _bloomComposer() {
        ...
        bloomComposer.setSize(this.sizes.width, this.sizes.height);
        bloomComposer.setPixelRatio(this.sizes.pixelRatio);
    ...
    _bloomPass() {
        ...
        unrealBloomPass.tintColor.value = this.state.unrealBloom.tintColor
        unrealBloomPass.tintColor.instance = new THREE.Color(unrealBloomPass.tintColor.value)

        unrealBloomPass.compositeMaterial.uniforms.uTintColor = {
            value: unrealBloomPass.tintColor.instance
        }
        unrealBloomPass.compositeMaterial.uniforms.uTintStrength = {
